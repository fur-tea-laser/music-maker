...
when defining interfaces use the following generic-naming scheme for properties where each property starts with the last word of the interface name like so, except for *Api interfaces, instead just pass in what makes sense for the context:
